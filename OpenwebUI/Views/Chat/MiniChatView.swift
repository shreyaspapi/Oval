...
struct MiniChatView: View {
    ...
    private var expandedToolbar: some View {
        HStack(spacing: 12) {
            ...
            .buttonStyle(.plain)
            .help(String(localized: "miniChat.close.help"))
            ...
            .buttonStyle(.plain)
            .help(String(localized: "miniChat.copyLastResponse.help"))
            ...
            .buttonStyle(.plain)
            .help(String(localized: "miniChat.newChat.help"))
        }
    }
        ...
        VStack(spacing: 0) {
            ...
            ZStack(alignment: .topLeading) {
                if appState.miniMessageInput.isEmpty {
                    Text(String(localized: "miniChat.askAnything"))
                        .font(.system(size: 15))
                        .foregroundStyle(Color(hex: "#666666"))
                        .padding(.leading, 4)
                        .padding(.top, 2)
            ...
            HStack(spacing: 2) {
                ...
                .buttonStyle(.plain)
                .help(String(localized: "miniChat.attach.help"))
                ...
                .buttonStyle(.plain)
                .help(String(localized: "miniChat.webSearch.help"))
                ...
                .buttonStyle(.plain)
                .help(String(localized: "miniChat.selectModel.help"))
                ...
                .buttonStyle(.plain)
                .help(String(localized: "miniChat.voiceInput.help"))
                ...
                VStack(alignment: .leading, spacing: 6) {
                    if message.content.isEmpty && isStreaming {
                        HStack(spacing: 4) {
                            ...
                            Text(String(localized: "miniChat.thinking"))
                                .font(.system(size: 13))
                                .foregroundStyle(Color(hex: "#999999"))
                        }
                    } else {
                    ...
                    if !message.content.isEmpty && !isStreaming {
                        HStack(spacing: 12) {
                            ...
                            .buttonStyle(.plain)
                            .help(String(localized: "miniChat.copy.help"))
                        }
                        .padding(.top, 2)
                    }
                }
