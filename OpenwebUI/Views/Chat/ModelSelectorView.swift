    ...
    var body: some View {
        Button {
            ...
            HStack(spacing: 6) {
                ...
                Text(appState.selectedModel?.displayName ?? String(localized: "model.selectModel"))
                    .font(.callout)
                    .lineLimit(1)
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack(spacing: 8) {
                ...
                TextField(String(localized: "model.searchPlaceholder"), text: $searchText)
            ...
            if filteredModels.isEmpty {
                VStack(spacing: 8) {
                    Image(systemName: "magnifyingglass")
                        .font(.system(size: 20))
                        .foregroundStyle(AppColors.textTertiary)
                    Text(appState.models.isEmpty ? String(localized: "model.noModels") : String(localized: "model.noMatchingModels"))
                        .font(.callout)
                        .foregroundStyle(AppColors.textTertiary)
                }
                    ...
                    Button {
                        ...
                        HStack(spacing: 4) {
                            ...
                            Text(appState.selectedModel.map { appState.isDefaultModel($0) } ?? false
                             ? String(localized: "model.defaultModel") : String(localized: "model.setAsDefault"))
                                 .font(.system(size: 11))
                        }
                        ...
                        Button {
                            ...
                            HStack(spacing: 4) {
                                Image(systemName: appState.isModelPinned(model) ? "pin.slash" : "pin")
                                    .font(.system(size: 11))
                                Text(appState.isModelPinned(model) ? String(localized: "model.unpin") : String(localized: "model.pinToSidebar"))
                                    .font(.system(size: 11))
                            }
...
private enum ModelFilter: Hashable {
    ...
    var label: String {
        switch self {
        case .all:      return String(localized: "model.filterAll")
        case .local:    return String(localized: "model.filterLocal")
        case .external: return String(localized: "model.filterExternal")
        }
    }
    ...
    var body: some View {
                    ...
                    HStack(spacing: 6) {
                        ...
                        if model.isLoaded {
                            Circle()
                                ...
                                .help(String(localized: "model.loadedInMemory.help"))
                        }
                    }
                ...
                if appState.isDefaultModel(model) {
                    Image(systemName: "star.fill")
                        ...
                        .foregroundStyle(AppColors.accentBlue)
                            .help(String(localized: "model.defaultModel.help"))
                }
        ...
        .contextMenu {
            ...
            Button {
                ...
                Label(appState.isModelPinned(model) ? String(localized: "model.unpinFromSidebar") : String(localized: "model.pinToSidebar"),
            ...
            Button {
                ...
                Label(appState.isDefaultModel(model) ? String(localized: "model.removeAsDefault") : String(localized: "model.setAsDefault"),
            ...
            Button {
                ...
                appState.toastManager.show(String(localized: "model.modelIDCopied"), style: .success)
            } label: {
                Label(String(localized: "model.copyModelID"), systemImage: "doc.on.doc")
            }
        }
    }
