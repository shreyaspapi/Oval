...
struct VoiceModeView: View {
    ...
    private var stateLabel: String {
        switch vm.sessionState {
        case .idle:         return String(localized: "voice.tapToStart")
        case .listening:    return String(localized: "voice.listening")
        case .transcribing: return String(localized: "voice.transcribing")
        case .thinking:     return String(localized: "voice.thinking")
        case .speaking:     return String(localized: "voice.speaking")
        case .error:        return String(localized: "voice.error")
        }
    }
    ...
    private var setupPrompt: some View {
        VStack(spacing: 12) {
            Text(String(localized: "voice.modelsNeeded"))
                .font(.system(size: 14, weight: .medium))
                .foregroundStyle(AppColors.textPrimary)

            Text(String(localized: "voice.downloadDescription"))
                .font(.system(size: 11))
                .foregroundStyle(AppColors.textTertiary)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 24)
            ...
            if raService.sttModelState == .downloading || raService.ttsModelState == .downloading {
                ...
                Button {
                    ...
                    Text(String(localized: "voice.downloadModels"))
    ...
    private var bottomControls: some View {
        VStack(spacing: 8) {
            ...
            Text(vm.isActive ? String(localized: "voice.tapToEnd") : String(localized: "voice.tapToStart"))
                .font(.system(size: 10))
                .foregroundStyle(AppColors.textTertiary)
        }
        .padding(.bottom, 24)
