...
struct ChatInputView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
                ...
                VStack(spacing: 0) {
                    ...
                    if appState.speechManager.isListening {
                        HStack(spacing: 8) {
                            ...
                            Text(appState.speechManager.transcript.isEmpty ? String(localized: "input.listening") : appState.speechManager.transcript)
                    ...
                    ZStack(alignment: .topLeading) {
                        if appState.messageInput.isEmpty && appState.pendingAttachments.isEmpty && !appState.speechManager.isListening {
                            Text(String(localized: "input.placeholder"))
                                .font(.system(size: 14))
                    ...
                    HStack(spacing: 4) {
                        ...
                        Button {
                            ...
                            HStack(spacing: 4) {
                                ...
                                if appState.isWebSearchEnabled {
                                    Text(String(localized: "input.search.label"))
                        ...
                        .buttonStyle(.plain)
                        .help(appState.isWebSearchEnabled ? String(localized: "input.webSearch.disable.help") : String(localized: "input.webSearch.enable.help"))
                        ...
                        .buttonStyle(.plain)
                        .help(appState.speechManager.isListening ? String(localized: "input.mic.stop.help") : String(localized: "input.mic.start.help"))
                        ...
                        .buttonStyle(.plain)
                        .help(String(localized: "input.voiceMode.help"))
                        ...
                        .buttonStyle(.plain)
                        .help(appState.isRealtimeTranscriptionActive ? String(localized: "input.transcription.stop.help") : String(localized: "input.transcription.start.help"))
            ...
            // Footer
            Text(String(localized: "input.footer"))
                .font(AppFont.caption(size: 11))
                .foregroundStyle(AppColors.textTertiary)
                .padding(.bottom, 8)
        }
    ...
    private func openFilePicker() {
        ...
        panel.title = String(localized: "input.attachFiles.title")
        panel.message = String(localized: "input.attachFiles.message")
